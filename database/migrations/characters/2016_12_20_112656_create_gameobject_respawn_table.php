...
class CreateGameobjectRespawnTable extends Migration {
	...
	public function up()
	{
		Schema::connection('characters')->create('gameobject_respawn', function(Blueprint $table)
		{
	...
	{
		Schema::connection('characters')->drop('gameobject_respawn');
	}
