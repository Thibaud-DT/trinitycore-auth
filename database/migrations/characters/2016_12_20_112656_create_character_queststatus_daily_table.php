...
class CreateCharacterQueststatusDailyTable extends Migration {
	...
	public function up()
	{
		Schema::connection('characters')->create('character_queststatus_daily', function(Blueprint $table)
		{
	...
	{
		Schema::connection('characters')->drop('character_queststatus_daily');
	}
