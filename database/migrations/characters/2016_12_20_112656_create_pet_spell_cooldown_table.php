...
class CreatePetSpellCooldownTable extends Migration {
	...
	public function up()
	{
		Schema::connection('characters')->create('pet_spell_cooldown', function(Blueprint $table)
		{
	...
	{
		Schema::connection('characters')->drop('pet_spell_cooldown');
	}
