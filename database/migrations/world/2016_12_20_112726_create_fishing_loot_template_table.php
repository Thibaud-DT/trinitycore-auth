...
class CreateFishingLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('fishing_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('fishing_loot_template');
	}
