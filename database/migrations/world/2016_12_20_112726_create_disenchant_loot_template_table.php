...
class CreateDisenchantLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('disenchant_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('disenchant_loot_template');
	}
