...
class CreateCreatureLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('creature_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('creature_loot_template');
	}
