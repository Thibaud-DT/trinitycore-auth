...
class CreateReferenceLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('reference_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('reference_loot_template');
	}
