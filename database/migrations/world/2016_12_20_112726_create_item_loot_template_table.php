...
class CreateItemLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('item_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('item_loot_template');
	}
