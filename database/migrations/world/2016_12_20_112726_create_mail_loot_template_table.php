...
class CreateMailLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('mail_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('mail_loot_template');
	}
