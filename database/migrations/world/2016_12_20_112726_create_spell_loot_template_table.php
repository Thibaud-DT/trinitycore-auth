...
class CreateSpellLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('spell_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('spell_loot_template');
	}
