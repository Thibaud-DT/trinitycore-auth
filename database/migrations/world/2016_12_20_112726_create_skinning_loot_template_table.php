...
class CreateSkinningLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('skinning_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('skinning_loot_template');
	}
