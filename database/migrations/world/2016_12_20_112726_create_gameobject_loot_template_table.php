...
class CreateGameobjectLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('gameobject_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('gameobject_loot_template');
	}
