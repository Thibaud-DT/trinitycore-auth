...
class CreateMillingLootTemplateTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('milling_loot_template', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('milling_loot_template');
	}
