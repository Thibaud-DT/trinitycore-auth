...
class CreateCreatureAddonTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('creature_addon', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('creature_addon');
	}
