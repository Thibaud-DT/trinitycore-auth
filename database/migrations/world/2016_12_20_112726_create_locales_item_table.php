...
class CreateLocalesItemTable extends Migration {
	...
	public function up()
	{
		Schema::connection('world')->create('locales_item', function(Blueprint $table)
		{
	...
	{
		Schema::connection('world')->drop('locales_item');
	}
